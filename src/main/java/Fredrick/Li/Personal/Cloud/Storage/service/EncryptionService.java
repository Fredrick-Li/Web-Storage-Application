...
public class EncryptionService {
    ...
    // I implement two-way hash encryption so that credentials can be hashed before stored into database and converted to original
    // before displaying on web page
